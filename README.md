...
Nanopore reads where aligned to GRCm38\_102/mm10 transcriptome (cDNA sequences from Ensamble database, version 102) with minimap2 (v. 2.24) sequence alignment program. Transcript isoform abundances were estimated by NanoCount (v1.0.0.post6) and reported as TPM. Threshold for relevant abundance was set at 2TPM.
